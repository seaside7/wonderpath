...
importers:
  ...
  apps/web:
    ...
    devDependencies:
      ...
      eslint-config-next:
        specifier: 16.2.9
        version: 16.2.9(@typescript-eslint/parser@8.62.1(eslint@9.39.4(jiti@2.7.0))(typescript@5.9.3))(eslint@9.39.4(jiti@2.7.0))(typescript@5.9.3)
      tailwindcss:
        specifier: ^4
        version: 4.3.2
      typescript:
...
snapshots:
  ...
  eslint-config-next@16.2.9(@typescript-eslint/parser@8.62.1(eslint@9.39.4(jiti@2.7.0))(typescript@5.9.3))(eslint@9.39.4(jiti@2.7.0))(typescript@5.9.3):
    dependencies:
      '@next/eslint-plugin-next': 16.2.9
      eslint: 9.39.4(jiti@2.7.0)
      eslint-import-resolver-node: 0.3.10
